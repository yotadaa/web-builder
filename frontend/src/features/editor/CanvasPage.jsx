...
import { MousePointer2, ChevronDown, Plus, ZoomOut, ZoomIn, RotateCcw, Minimize, Maximize, Grid3X3, Ruler, ChevronLeft, PanelLeftOpen, PanelRightOpen, Play, ChevronUp, Code, PanelLeftClose, PanelRightClose, Wand2, Type, Layout, Settings, Layers, ChevronRight, X, Copy, Square, Circle, Image, Type as TypeIcon, Save, History, Redo, Undo, Trash2, Edit3, FileJson } from 'lucide-react';
...
export const CanvasPage = () => {
    ...
    const prepareCanvasElements = useCallback((container) => {
        ...
        elements.forEach(el => {
            // Skip system tags and certain non-interactive elements
            if (['STYLE', 'SCRIPT', 'BR', 'HR'].includes(el.tagName)) return;
            if (el.id === 'global-project-styles' || el.id === 'global-project-scripts') return;
            // Handle SVGs: tag the root SVG but maybe not every path
    ...
    const handleApplySpark = (suggestion) => {
        ...
        // Ensure new elements have IDs and the tree is updated
    ...
    return (
        <div style={{
            ...
            <div style={{ position: 'absolute', top: '-10%', left: '-5%', width: '500px', height: '500px', background: accentColor, borderRadius: '50%', filter: 'blur(120px)', opacity: 0.15, pointerEvents: 'none', zIndex: 0 }} />
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                                    ...
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                                        ...
                                        <Textarea
                                            ...
                                            inputStyle={{ minHeight: '80px', fontSize: '0.8125rem', fontFamily: 'monospace' }}
                                        />
                                    </div>
                                            ...
                                            {cssProperties.map((p, i) => (
                                                <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '8px', background: 'rgba(255,255,255,0.03)', borderRadius: '6px', padding: '4px 8px', border: '1px solid rgba(255,255,255,0.05)' }}>
                                                    <Input
                                                        ...
                                                        inputStyle={{ background: 'transparent', border: 'none', color: '#94a3b8', fontSize: '11px', padding: 0, boxShadow: 'none' }}
                                                    />
                                                    ...
                                                    <Input
                                                        ...
                                                        inputStyle={{ background: 'transparent', border: 'none', color: accentColor, fontSize: '11px', padding: 0, boxShadow: 'none' }}
                                                    />
                                                    <button
                                                        onClick={() => {
                                    ...
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                                        ...
                                        <Textarea
                                            ...
                                            inputStyle={{ minHeight: '60px', fontSize: '0.8125rem', fontFamily: 'monospace' }}
                                        />
                                    </div>
